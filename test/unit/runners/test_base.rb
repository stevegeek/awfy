...
class TestAbstractRunner < Minitest::Test
  ...
  # def test_run_groups
  #   # Test that run yields all groups
  #   yielded_groups = []
  #   @runner.run { |group| yielded_groups << group }
  #
  ...
  #   # Skip this test since it's verifying a functionality that no longer exists
  #   # in the same way in the new implementation
  #   skip "The prepare_output_directory method is no longer part of the public API"
  # end
  #
  # def test_run_command
  #   # Test that NoMethodError is raised for Base
  #   base_runner = Awfy::Runners::Base.new(session: @session, suite: @suite)
  #   assert_raises(NoMethodError) do
  #     base_runner.run_group(nil)
  #   end
  # end
  #
