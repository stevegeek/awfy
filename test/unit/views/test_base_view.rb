...
module Awfy
  module Views
    class TestBaseView < ViewTestCase
      def setup
        super # From ViewTestCase
        @view = BaseView.new(session: @session)
      end

      def test_initialization
        assert_instance_of BaseView, @view
      end
      ...
      class TestBaseViewWithSummary < BaseView
        def show_summary?
          config.show_summary?
        end
      end
      ...
      def test_format_table
        ...
        table_string = @view.render_table(mock_table)
