...
class SqliteResultStoreTest < Minitest::Test
  ...
  def test_query_results
    ...
    result_id1 = @store.store_result(:ips, "Query Group", "#method1", "ruby", metadata1) do
      { ips: 1000.0 }
    end
    ...
    result_id2 = @store.store_result(:ips, "Query Group", "#method1", "yjit", metadata2) do
      { ips: 1500.0 }
    end
    ...
    result_id3 = @store.store_result(:ips, "Another Group", "#method2", "ruby", metadata3) do
      { ips: 2000.0 }
    end
